          ...
          {vendorInventory.length === 0 ? (
            ...
            vendorInventory.map(crop => {
              ...
              const cropDescriptions: Record<string, string> = {
                ...
                'mango-carabao': 'World-famous Carabao mango — the sweetest mango variety in the world.',
              ...
              return (
                <div key={crop.id} className="bg-white dark:bg-zinc-900/80 border border-zinc-200 dark:border-zinc-800/80 rounded-2xl sm:rounded-[28px] overflow-hidden group hover:border-green-400/40 transition-all duration-300 shadow-lg hover:shadow-2xl hover:shadow-green-500/5 dark:hover:shadow-green-500/10">
                  ...
                  <div className="relative h-48 sm:h-56 w-full overflow-hidden" style={{ background: `linear-gradient(145deg, ${cropColors[0]}18 0%, ${cropColors[1]}25 50%, ${cropColors[0]}12 100%)` }}>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      {myEntry.customPhoto ? (
                        ...
                        <span className="text-8xl drop-shadow-2xl group-hover:scale-110 transition-transform duration-500">{crop.icon || '📦'}</span>
                      )}
                    </div>
                  ...
                  {/* === MIDDLE ROW: Thumbnail + Crop Identity + Trend === */}
                  <div className="px-5 sm:px-6 -mt-3 flex items-start gap-3.5 relative z-10">
                    {/* Thumbnail */}
                    ...
                    <div className="flex-1 min-w-0 pt-1">
                      ...
                      <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                        ...
                        {/* Your Photo badge */}
                        {myEntry.customPhoto && (
                          <span className="px-2.5 py-1 rounded-lg bg-blue-400/10 text-[9px] font-black text-blue-500 dark:text-blue-400 uppercase tracking-widest flex items-center gap-1 border border-blue-500/15">
                            <Camera size={10} />
                            Your Photo
                          </span>
                        )}
                  ...
                  <div className="px-5 sm:px-6 pt-4 pb-5 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3 pt-1">
                      <button
                        ...
                        className="flex items-center justify-center gap-2 bg-green-500 hover:bg-green-400 text-white px-4 py-3.5 rounded-2xl font-black text-[11px] uppercase tracking-widest transition-all duration-200 hover:shadow-xl hover:shadow-green-500/25 active:scale-[0.97]"
                      >
                        <Edit2 size={14} strokeWidth={2.5} />
                        Edit Listing
                      </button>
                      <button
                        onClick={() => handleDeleteFromInventory(crop.id)}
                        className="flex items-center justify-center gap-2 bg-zinc-100 dark:bg-zinc-800 hover:bg-red-500 text-zinc-500 dark:text-zinc-400 hover:text-white border border-zinc-200 dark:border-zinc-700 hover:border-red-500 px-4 py-3.5 rounded-2xl font-black text-[11px] uppercase tracking-widest transition-all duration-200 hover:shadow-xl hover:shadow-red-500/25 active:scale-[0.97]"
                      >
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex items-start gap-2.5 mt-3 p-3 rounded-xl bg-amber-500/10 dark:bg-amber-500/5 border border-amber-400/20">
                    ...
                    <p className="text-[10px] text-amber-600 dark:text-amber-400 leading-relaxed">
                      <span className="font-black">Photo will be checked by admin.</span> Please use your real photo of the crop — photos taken from the internet will be rejected. Take a picture of your actual product at your stall.
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:gap-4">
                    <div className="space-y-2 col-span-2">
                      <label className="text-[10px] font-black text-zinc-400 dark:text-zinc-500 ml-2 tracking-widest uppercase">Product Name {!addCropModalSelection ? '(Required — type your crop name)' : '(Optional)'}</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-black text-zinc-400 dark:text-zinc-500 ml-2 tracking-widest uppercase">Price per kg (₱)</label>
                ...
                <div className="p-4 rounded-2xl bg-blue-500/5 dark:bg-blue-500/5 border border-blue-400/15">
                  ...
                  <ul className="text-[10px] text-zinc-500 dark:text-zinc-400 space-y-1.5 leading-relaxed ml-1">
                    <li>📸 <strong>Take a clear photo</strong> of your crop at your stall or farm</li>
                    <li>🏷️ <strong>Can't find your crop?</strong> Skip the selection and just type the name (e.g. "Durian", "Lychee")</li>
                    <li>📱 <strong>No photo yet?</strong> You can still list now and add a photo later using "Edit Listing"</li>
                    <li>✅ <strong>Real photos only</strong> — Admin will check that photos are real and not from the internet</li>
                  </ul>
                </div>
              </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-6">
          ...
          <div className="bg-white dark:bg-zinc-900 w-full max-w-lg rounded-3xl sm:rounded-[50px] p-5 sm:p-8 lg:p-12 relative border border-zinc-200 dark:border-zinc-800 text-center space-y-6 sm:space-y-10 animate-in zoom-in-95 duration-200 shadow-2xl max-h-[90vh] overflow-y-auto scrollbar-hide">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-6 text-left">
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black text-zinc-400 dark:text-zinc-500 uppercase ml-3 tracking-widest">Price per kg (₱)</label>
