  ...
  return (
    <div className="space-y-4 sm:space-y-8 pb-28 lg:pb-12 animate-in fade-in duration-500">
      ...
      {favoriteCrops.length > 0 && (
        <div id="favorites-section" className="pt-4 scroll-mt-24">
          <h2 className="text-2xl sm:text-3xl font-black tracking-tighter flex items-center gap-3 mb-6">
            <Heart className="text-red-500" fill="currentColor" size={28} />
            {t('sections.yourFavorites', 'Your Favorites')}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 sm:gap-6">
            {favoriteCrops.map(renderCropCard)}
          </div>
        </div>
      )}
