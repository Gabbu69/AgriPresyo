...
def fix_upo_best():
    ...
    if not path:
        # Fallback to the known source image if new_uploads is empty
        path = r"c:\Users\gabri\.gemini\antigravity\brain\38e74002-8293-4e72-b777-ad5cb76bf9b3\media__1774782529739.jpg"
    ...
    # Use a much taller rectangle so we DO NOT cut the tip or bottom!
    # x, y, width, height
    # x: 25% to 75%
    # y: 2% to 98% (almost the whole height)
    ...
    out_debug = os.path.join(CROPS_DIR, "upo_debug.png")
    
    canvas.save(out_path, "PNG")
    canvas.save(out_debug, "PNG")
    print("Done GrabCut for Upo with FULL height!")
