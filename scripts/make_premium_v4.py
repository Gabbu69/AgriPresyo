...
# THIS IS THE ACTUAL NEW PINEAPPLE IMAGE UPLOADED AT 20:06
src = r"C:\Users\gabri\.gemini\antigravity\brain\f569a168-fe18-42be-856c-b26a1c80a258\media__1774785722605.png"
dst = r"c:\Users\gabri\.gemini\antigravity\scratch\AgriPresyo\public\crops\pineapple_premium_v4.png"

def make_it_premium():
    print("Extracting the REAL right pineapple...")
    try:
        with Image.open(src) as img:
            ...
            # Use alpha matting for perfect premium edges!
            ...
            # Premium format: target fruit size = 440
            target_h = 440
