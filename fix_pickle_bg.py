...
def main():
    img_path = r"C:\Users\gabri\.gemini\antigravity\brain\1a59ed54-5459-40bb-82f2-3dc500fa59d5\media__1774763179015.jpg"
    ...
    # Standardize size: 512x512 canvas, pickle takes ~80%
    ...
    out_path_ultimate = os.path.join(out_dir, "pickle_ultimate.png")
    out_path_final = os.path.join(out_dir, "pickle_final.png")
    
    final_canvas.save(out_path_ultimate, "PNG")
    final_canvas.save(out_path_final, "PNG")
    
    print(f"Saved successfully to {out_path_ultimate} and {out_path_final}")
