...
def fix_upo_clean():
    ...
    # Grabcut rectangle around the Upo. The Upo takes up the center of the image.
    rect = (int(w * 0.25), int(h * 0.1), int(w * 0.5), int(h * 0.8))
    ...
    print("Done GrabCut for ACTUAL Upo!")
